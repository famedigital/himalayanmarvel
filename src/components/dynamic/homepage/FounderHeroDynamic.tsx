...
interface FounderHeroDynamicProps {
  content: {
...
export function FounderHeroDynamic({ content }: FounderHeroDynamicProps) {
  const { theme, resolvedTheme } = useTheme();
  const isDark = resolvedTheme === 'dark' || theme === 'dark';
  const yearsOfService = getYearsOfServiceString();

  const {
    portraitImage = 'https://res.cloudinary.com/dxztrqjft/image/upload/v1776275660/founder-portrait_pbo8m4.jpg?v=20260506',
          ...
          >
            <div className="relative">
              ...
              >
                ...
                <p className="text-xs uppercase tracking-[0.2em] font-semibold mt-2 text-neutral-600 dark:text-white/60">
              ...
              >
                ...
                <div>
                  <p className="text-sm font-semibold text-neutral-900 dark:text-neutral-100">
                    {licensed && 'Licensed'}{insured && licensed && ' & '}{insured && 'Insured'}
                  </p>
