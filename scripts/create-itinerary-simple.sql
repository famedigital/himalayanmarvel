...
-- STEP 2: Clear any existing test data (optional)
...
-- STEP 3: Insert the test itinerary
...
SELECT
  ...
  'https://res.cloudinary.com/dlv3qqv3f/image/upload/v1776291879/tiger-nest-close_rm2bee.jpg',
  ARRAY['Traditional welcome ceremony', 'Scenic mountain drive', 'Thimphu city exploration']::TEXT[],
...
SELECT
  ...
  ARRAY['Tashichho Dzong visit', 'National Museum tour', 'Local market experience']::TEXT[],
  'Hotel breakfast',
...
SELECT
  ...
  'https://res.cloudinary.com/dlv3qqv3f/image/upload/v1776291902/buddha-point-view_skbl41.jpg',
  ARRAY['Dochula Pass crossing', 'Punakha Dzong visit', 'Chimi Lhakhang temple']::TEXT[],
