/**
 * Seed Homepage Content to Settings Table
...
const homepageContent = {
  ...
  about_page: {
    ...
    story: 'Founded by ex-Ritz-Carlton leadership, Himalayan Marvels brings luxury hospitality standards to Bhutan...',
    mission: 'To create transformative travel experiences that go beyond tourism...',
...
async function seedHomepageContent() {
  console.log('🌱 Seeding homepage content to settings table...\n');
  ...
  console.log(`\n🎉 Your homepage now has real data! Visit /admin/frontend to edit it.\n`);
}
