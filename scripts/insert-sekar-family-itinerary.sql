-- Insert Sekar Family Itinerary into the database
-- Run this in Supabase SQL Editor

-- First, insert the main itinerary record
INSERT INTO itineraries (
    ...
    "items": [
      {
        ...
        "description": "Ama''s Farmstay Guma & Paro (4 nights) + Premium Hotels (2 nights) + Phuentsholing (1 night)",
        "amount": ""
      },
      {
        "label": "Meals",
        "description": "Daily breakfast & dinner (MAP plan)",
        "amount": ""
      },
      {
        "label": "Premium Transport",
        "description": "Hyundai Santa Fe or similar SUV with experienced driver",
        "amount": ""
      },
      {
        "label": "English-Speaking Guide",
        "description": "Licensed, knowledgeable guide throughout Bhutan",
        "amount": ""
      }
    ],
    "inclusions": [
  ...
  '{
    "documents": [
      ...
      "Voter ID (for Indian nationals)",
      "Travel insurance documents",
      "Flight tickets (QP-1850/QP-1851)",
      "Passport size photos (4 copies)",
      "Children''s school ID/birth certificate",
      "Emergency contact numbers",
      "Medical prescriptions"
    ],
    "clothing": [
      "Comfortable walking shoes",
      "Light woolens/sweaters",
      "Windproof jacket",
      "Casual cotton clothes",
      "Sunglasses & sun hat",
      "Sturdy trekking shoes",
      "Warm jacket/sweater",
      "Comfortable pants (no jeans for trek)",
      "Cap/hat",
      "Extra layer for evenings"
    ],
    "gear": [
      "Sturdy hiking shoes",
      "Comfortable socks (2 pairs)",
      "Light backpack",
      "Water bottle (1L)",
      "Sunscreen & hat",
      "Light rain jacket",
...
-- Save the itinerary ID for use in subsequent inserts
-- The returned ID will be used in the next statements

-- After running the above, note the returned UUID and use it below:
-- Replace {ITINERARY_ID} with the actual UUID returned from the insert above
...
INSERT INTO itinerary_days (
  ...
  '{ITINERARY_ID}',  -- Replace with actual UUID
  1,
  ...
  ARRAY[
    ...
    'Guide Welcomes at Jaigaon',
    'Mountain Ascent to Thimphu'
  ]::TEXT[],
...
INSERT INTO itinerary_days (
  ...
  ARRAY[
    ...
    'Lunch at Ama''s OR Local Restaurant',
    'Ama''s Farmstay Tour'
  ]::TEXT[],
...
INSERT INTO itinerary_section_openers (
  ...
  ('{ITINERARY_ID}', 1, 'THE JOURNEY BEGINS', 'Bangalore • Bagdogra • Thimphu', 'https://scontent.fpbh2-1.fna.fbcdn.net/v/t39.30808-6/606265855_1291141999719160_3376584168833227975_n.jpg?stp=cp6_dst-jpg_tt6&_nc_cat=106&ccb=1-7&_nc_sid=7b2446&_nc_ohc=iKOhprIuwxgQ7kNvwG8ccwQ&_nc_oc=AdoBOHf9CNVoM0MT-Y12Swj5y18icebYOtCIFzhm99TBB3ltgYgzlcA33chqLHGPyzI&_nc_zt=23&_nc_ht=scontent.fpbh2-1.fna&_nc_gid=CmMroEa6xZISOi20DkQ-DQ&_nc_ss=7b289&oh=00_Af2ketFlvaFu-mU_I9HvQ-2Yp9_1e3j3CS5UclV2n7pfwQ&oe=69F4FE9D', 'rgba(45,90,61,0.6)', 4),
  ('{ITINERARY_ID}', 2, 'THIMPHU DISCOVERY', 'Cultural Exploration Day', 'https://scontent.fpbh2-1.fna.fbcdn.net/v/t39.30808-6/484996524_1062415295921391_2163630259581809224_n.jpg?_nc_cat=101&ccb=1-7&_nc_sid=13d280&_nc_ohc=YA09lCGw0K8Q7kNvwFVvRQ4&_nc_oc=AdpVNrrAUTxQDES238KC_1WVOn4cOxrky5K-MkdFNZCiGTSd4Q2-uwlB7JSN1yQ6zP4&_nc_zt=23&_nc_ht=scontent.fpbh2-1.fna&_nc_gid=SpU8FrN-HbWBwVDpt9k4GQ&_nc_ss=7b289&oh=00_Af28Xkaplgmv6J9oZ-h_0M6-1veY8pu6tW-NjuMFfLS9tg&oe=69F4D44C', 'rgba(45,90,61,0.6)', 6),
  ('{ITINERARY_ID}', 3, 'VALLEYS OF WONDER', 'Punakha • Guma • Ama''s Farmstay', 'https://drukcdn.blob.core.windows.net/www/images/media/punakha-dzong2.jpg', 'rgba(45,90,61,0.6)', 8),
  ('{ITINERARY_ID}', 4, 'PARO VALLEY', 'Traditional Town & Culture', 'https://scontent.fpbh2-1.fna.fbcdn.net/v/t39.30808-6/493174133_1093858149443772_2484001306497428332_n.jpg?_nc_cat=102&ccb=1-7&_nc_sid=13d280&_nc_ohc=6sHieJp_tEcQ7kNvwE1jd-x&_nc_oc=Adq-inR6NWm5PSPXIfa8VMefeEtZV6W4VeXgJW6ZvCjsxUf1vnowe4YUwsgusTnWh8U&_nc_zt=23&_nc_ht=scontent.fpbh2-1.fna&_nc_gid=5kpLogRGxF71n-bEnbXfBQ&_nc_ss=7b289&oh=00_Af0Gi5jiKMJd7iA9zdZBY9SRmECQwh-u4qNUz24md2hRKA&oe=69F50B69', 'rgba(45,90,61,0.6)', 10),
  ('{ITINERARY_ID}', 5, 'THE SACRED HIKE', 'Tiger''s Nest • A Spiritual Journey', 'https://www.aliveoutdoors.com/wp-content/uploads/2023/03/Library-11-of-57-scaled.jpeg', 'rgba(45,90,61,0.6)', 12);

-- After inserting, reload the schema cache
